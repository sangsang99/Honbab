...
<body>
	...
	<div class="wrap" align="center">
		<div class="challenge_save write">
			<form action="${contextPath }/challengeSave" enctype="multipart/form-data" method="post">
        ...
        <span id="text"></span>
        <p>작성자</p>
        <input type="text" name="uWriter" value="${loginUser}" readonly="readonly">
				<p>제목</p>
				<input type="text" name="uTitle" size="50"><br>
				
				<p>내용</p>
				<textarea rows="10" cols="50" name="uContent"></textarea><br>
				
				<b>첨부한 파일</b>
				<input type="file" name="uImgName" onchange="readURL(this)"><br>
				<img src="#" id="preview" width="100px"><br>
				<br>

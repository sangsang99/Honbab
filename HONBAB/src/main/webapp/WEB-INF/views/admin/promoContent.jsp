			...
			<tr>
				<td colspan="4" align="center">
					...
					<input type="button" value="삭제하기"
							onclick="location.href='${contextPath}/admin/delete?writeNo=${data.writeNo }&imageFileName=${data.imageFileName }'">
					&nbsp; <input type="button" value="글목록"
					onclick="location.href='${contextPath}/admin/promoBoard'">
				</td>
			</tr>
		</table>
	</div>

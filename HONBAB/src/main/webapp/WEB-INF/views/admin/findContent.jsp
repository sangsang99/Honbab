...
<body>
	...
	<input type="button" value="목록 돌아가기" onclick="location.href='${contextPath}/admin/findBoard'"> &nbsp;
	<c:if test="${true == true}">
	<input type="button" value="삭제하기" onclick="location.href='${contextPath}/admin/find_delete?writeNo=${findContent.writeNo}'">
	</c:if>

...
public class AdminController implements AdminSession{
	...
	public String adminBan() {
		return "admin/adminBan";
	}	
	
	@PostMapping("general_delete") //일반회원 삭제
	public void general_delete(@RequestParam("adminId") String id,HttpServletResponse response, HttpServletRequest request) throws IOException{
	...
	@PostMapping("partner_delete") //파트너 삭제
	public void partner_delete(@RequestParam("adminId") String id,HttpServletResponse response, HttpServletRequest request) throws IOException{

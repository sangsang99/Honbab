...
public class ChallengeController implements MemberSession {
	...
	public void challengeSave(MultipartHttpServletRequest mul, HttpServletResponse response, HttpServletRequest request)
			throws IOException {
	...
	public void challengeModify(MultipartHttpServletRequest mul, HttpServletResponse response,

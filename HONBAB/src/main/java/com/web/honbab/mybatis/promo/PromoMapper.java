...
public interface PromoMapper {
	...
	public List<PromoRepDTO> searchForComName(@Param("keyword") String keyword, @Param("s") int start,
			@Param("e") int end);

	public List<PromoRepDTO> searchForAddress(@Param("keyword") String keyword, @Param("s") int start,
			@Param("e") int end);
